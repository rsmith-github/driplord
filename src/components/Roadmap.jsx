...
const Roadmap = () => {
  ...
  return (
    ...
    >
      ...
      <Slide direction="up">
        <h1 className="absolute left-1/2 -translate-x-1/2 -translate-y-[30vh] text-[clamp(1rem,3vw,5rem)] font-bold text-white text-center uppercase tracking-wider font-menda">
          ROADMAP
        </h1>
      </Slide>
